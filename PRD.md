...
### 8.2 Arah Desain Terpilih (COMMITTED) — *Dark Premium, Aksen Tunggal*
...
*(Alternatif yang juga valid jika klien memilih terang: "Minimalist Grid" — kanvas putih bersih, grid ketat, satu aksen gelap pekat, tipografi besar. Pilih SATU saja; dokumen ini mengunci Dark Editorial Garage sebagai default.)*
...
*Display serif kontras tinggi* **Fraunces** atau **Playfair Display** + *body* **Inter**. Pilih SATU sistem dan konsisten.
...
*Dokumen ini adalah sumber kebenaran (single source of truth) untuk pembangunan PREMIUM CARS. Perubahan signifikan harus memperbarui versi dokumen.*
